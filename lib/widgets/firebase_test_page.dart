...
class FirebaseTestPage extends StatefulWidget {
  ...
  @override
  _FirebaseTestState createState() => _FirebaseTestState(analytics, observer);
}

class _FirebaseTestState extends State<FirebaseTestPage> {
  _FirebaseTestState(this.analytics, this.observer);
